...
def create_consumer():
    consumer_config = {
        'bootstrap.servers': 'localhost:9093',  # Endereço dos brokers Kafka
        'group.id': 'user-registration-group',  # Nome do grupo do consumidor
        'auto.offset.reset': 'earliest',       # Começar do início se não houver offset salvo
    }
